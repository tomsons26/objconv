...
SErrorText ErrorTexts[] = {
   ...
   {1055, 1, "Communal section currently not supported by objconv. Section dropped: 0x%08X"},
   ...
   {2311, 2, "Relocation of iterated data not supported by objconv: 0x%08X"},
   {2312, 2, "FIXUPP record does not refer to data record: 0x%08X"},
