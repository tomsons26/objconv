...
SErrorText ErrorTexts[] = {
   ...
   {1055, 1, "Communal section 0x%X currently not supported by objconv. Section dropped"},
   ...
   {2311, 2, "Relocation of iterated data not supported by objconv, 0x%X"},
   {2312, 2, "FIXUPP record does not refer to data record: 0x%X"},
