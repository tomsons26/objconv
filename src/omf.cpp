...
SIntTxt OMFRecordTypeNames[] = {
   ...
   {OMF_BLKDEF + 1,  "32-bit Block Definition"},
   {OMF_BLKEND,      "Block End"},
   {OMF_BLKEND + 1,  "32-bit Block End"},
   ...
   {OMF_BAKPAT + 1,  "32-bit Backpatch"},
   {OMF_LEXTDEF,     "Local External Names Definition"},
   {OMF_LEXTDEF + 1, "32-bit Local External Names Definition"},
   {OMF_LPUBDEF,     "Local Public Names Definition"},
   {OMF_LPUBDEF + 1, "32-bit Local Public Names Definition"},
   ...
   {OMF_COMDAT + 1,  "32-bit Initialized Communal Data"},
   {OMF_LINSYM,      "Symbol Line Numbers"},
   {OMF_LINSYM + 1,  "32-bit Symbol Line Numbers"},
   {OMF_ALIAS,       "Alias Definition"},
   {OMF_NBKPAT,      "Named Backpatch"},
   {OMF_NBKPAT + 1,  "32-bit Named Backpatch"},
